...
/mob/living/silicon/robot/proc/notify_ai(notifytype, oldname, newname)
	...
	switch(notifytype)
		if(1) //New Cyborg
			connected_ai.text2tab("<br><br><span class='notice'>NOTICE - New cyborg connection detected: <a href='?src=\ref[connected_ai];track=[rhtml_encode(name)]'>[name]</a></span><br>")
		if(2) //New Module
